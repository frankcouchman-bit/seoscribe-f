  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="SEOScribe privacy policy - How we collect, use, and protect your data." />
        <link rel="canonical" href="https://seoscribe.pro/privacy" />
      </Helmet>
          ...
          >
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-white/80 ml-4">
                ...
                <li>Serper API for search and research</li>
              </ul>
            </section>
